<?php include('application/views/template/header.php'); ?>
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-truck" aria-hidden="true"></i> Fornecedores cadastrados</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
         <button class="btn btn-primary  btn-xs" data-toggle="modal" data-target="#myModalCriar">Cadastrar novo fornecedor</button>
            </div>
		...
		<th>Ações</th>
			...
			<td width="200px">
				...
				<?php 
				echo anchor(site_url('fornecedor/delete/'.$start),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-flat btn-danger btn-xs" onclick="javasciprt: return confirm(\'Você tem certeza ?\')"'); 
				?>
				<?php 
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel"><?php echo $fornecedor->razao_social ?></h4>
						      </div>
						...
						<div class="modal fade" id="myModal<?php echo $start ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
                                <span class="view_line"><span class="title_line">Razão social: </span><?php echo $fornecedor->razao_social ?></span>
                                <span class="view_line"><span class="title_line">Cnpj: </span><?php echo $fornecedor->cnpj ?></span>
                                <span class="view_line"><span class="title_line">DDD1: </span><?php echo$fornecedor->ddd1 ?></span>
                                <span class="view_line"><span class="title_line">Telefone 1: </span><?php echo $fornecedor->telefone1 ?></span>
                                <span class="view_line"><span class="title_line">DDD2: </span><?php echo $fornecedor->ddd2 ?></span>
                                <span class="view_line"><span class="title_line">Telefone 2: </span><?php echo$fornecedor->telefone2 ?></span>
                                <span class="view_line"><span class="title_line">Email: </span><?php echo $fornecedor->email ?></span>
                                <span class="view_line"><span class="title_line">Ativo: </span><?php echo $fornecedor->ativo ?></span>
                                <span class="view_line"><span class="title_line">Empresa: </span><?php echo$fornecedor->empresa_id ?></span>
                                </div>
						...
						<div class="modal fade" id="myModalCriar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						        <h4 class="modal-title" id="myModalLabel">Cadastrar novo fornecedor</h4>
						      </div>
						      <div class="modal-body">
