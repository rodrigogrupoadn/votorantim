...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Obra List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('obra/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('obra'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
